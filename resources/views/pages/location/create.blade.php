  ...
  <div class="col-12">
    <div class="card mb-4 shadow-sm border-radius-xl" style="border: none;">
      <div class="card-header pb-0 bg-transparent">
        <h4 class="font-weight-bolder mb-1" style="color: #ec407a;">Location <span class="text-secondary font-weight-normal" style="font-size: 1.35rem;">Input Form</span></h4>
      </div>
        ...
        <form action="{{ route('location.store') }}" method="POST">
          ...
          <div class="mb-4">
            ...
            <div class="input-group input-group-outline bg-white rounded-3" style="border: 1px solid #d2d6da;">
              <input type="text" id="location_name" name="location_name" class="form-control border-0 bg-transparent py-2 ps-3 @error('location_name') is-invalid @enderror" placeholder="Gedung A" value="{{ old('location_name') }}" required style="height: 43px; box-shadow: none; outline: none; border-radius: 8px;">
            </div>
          ...
          <div class="mb-4">
            ...
            <div class="input-group input-group-outline bg-white rounded-3" style="border: 1px solid #d2d6da;">
              <input type="number" id="max_motorcycle" name="max_motorcycle" class="form-control border-0 bg-transparent py-2 ps-3 @error('max_motorcycle') is-invalid @enderror" placeholder="0" min="0" value="{{ old('max_motorcycle', 0) }}" required style="height: 43px; box-shadow: none; outline: none; border-radius: 8px;">
            </div>
          ...
          <div class="mb-4">
            ...
            <div class="input-group input-group-outline bg-white rounded-3" style="border: 1px solid #d2d6da;">
              <input type="number" id="max_car" name="max_car" class="form-control border-0 bg-transparent py-2 ps-3 @error('max_car') is-invalid @enderror" placeholder="0" min="0" value="{{ old('max_car', 0) }}" required style="height: 43px; box-shadow: none; outline: none; border-radius: 8px;">
            </div>
          ...
          <div class="mb-4">
            ...
            <div class="input-group input-group-outline bg-white rounded-3" style="border: 1px solid #d2d6da;">
              <input type="number" id="max_other" name="max_other" class="form-control border-0 bg-transparent py-2 ps-3 @error('max_other') is-invalid @enderror" placeholder="0" min="0" value="{{ old('max_other', 0) }}" required style="height: 43px; box-shadow: none; outline: none; border-radius: 8px;">
            </div>
