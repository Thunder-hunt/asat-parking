  ...
  <div class="col-12">
    <div class="card mb-4 shadow-sm border-radius-xl" style="border: none;">
      <div class="card-header pb-0 bg-transparent">
        <h4 class="font-weight-bolder mb-1" style="color: #ec407a;">Vehicle Type <span class="text-secondary font-weight-normal" style="font-size: 1.35rem;">Edit Form</span></h4>
      </div>
      <div class="card-body p-4 pt-3">
        <form action="{{ route('vehicle-type.update', $type->id) }}" method="POST">
          ...
          <div class="mb-4">
            ...
            <div class="input-group input-group-outline bg-white rounded-3" style="border: 1px solid #d2d6da;">
              <select id="jenis" name="jenis" class="form-control border-0 bg-transparent py-2 ps-3 @error('jenis') is-invalid @enderror" required style="height: 43px; box-shadow: none; outline: none; border-radius: 8px;">
                ...
                <option value="motorcycle" {{ old('jenis', $type->jenis) == 'motorcycle' ? 'selected' : '' }}>Motor (Motorcycle)</option>
                <option value="car"        {{ old('jenis', $type->jenis) == 'car'        ? 'selected' : '' }}>Mobil (Car)</option>
                <option value="other"      {{ old('jenis', $type->jenis) == 'other'      ? 'selected' : '' }}>Lainnya (Other)</option>
              </select>
            </div>
          ...
          <div class="mb-4">
            ...
            <div class="input-group input-group-outline bg-white rounded-3" style="border: 1px solid #d2d6da;">
              <input type="number" id="perjam_pertama" name="perjam_pertama" class="form-control border-0 bg-transparent py-2 ps-3 @error('perjam_pertama') is-invalid @enderror" placeholder="e.g. 2000" min="0" value="{{ old('perjam_pertama', $type->perjam_pertama) }}" required style="height: 43px; box-shadow: none; outline: none; border-radius: 8px;">
            </div>
          ...
          <div class="mb-4">
            ...
            <div class="input-group input-group-outline bg-white rounded-3" style="border: 1px solid #d2d6da;">
              <input type="number" id="perjam_berikutnya" name="perjam_berikutnya" class="form-control border-0 bg-transparent py-2 ps-3 @error('perjam_berikutnya') is-invalid @enderror" placeholder="e.g. 1000" min="0" value="{{ old('perjam_berikutnya', $type->perjam_berikutnya) }}" required style="height: 43px; box-shadow: none; outline: none; border-radius: 8px;">
            </div>
          ...
          <div class="mb-4">
            ...
            <div class="input-group input-group-outline bg-white rounded-3" style="border: 1px solid #d2d6da;">
              <input type="number" id="max_perhari" name="max_perhari" class="form-control border-0 bg-transparent py-2 ps-3 @error('max_perhari') is-invalid @enderror" placeholder="e.g. 20000" min="0" value="{{ old('max_perhari', $type->max_perhari) }}" required style="height: 43px; box-shadow: none; outline: none; border-radius: 8px;">
            </div>
